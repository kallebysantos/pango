...
public class RegistryManager() : IRegistryManager
{
  ...
  )
  {
    ...
    if (componentFolder.IsErr())
      return new InvalidComponentPathError(Path: metadataInput.LocalComponentPath);
    ...
    return componentFolder
        ...
        .OkOr<IRegistryError>(new InvalidComponentPathError(Path: metadataInput.LocalComponentPath))
  ...
  protected static Result<ComponentMetadata, IRegistryError> ResolveComponent(string path) =>
      Result
          ...
          .OkOr<IRegistryError>(new InvalidComponentPathError(Path: path));
